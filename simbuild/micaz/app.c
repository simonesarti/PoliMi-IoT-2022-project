...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7bcf458, const void *arg_0xb7bcf5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b808c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a2a840), 
int (*key_eq_fn)(void *arg_0xb7a2ac88, void *arg_0xb7a2ae00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78f99b8, int arg_0xb78f9b10);
static double RandomUniform(void );
...
typedef TMilli projectC$Pairing_Timer$precision_tag;
typedef TMilli projectC$Info_Timer$precision_tag;
typedef info_data_t projectC$FakeSensor$val_t;
typedef TMilli projectC$OutOfRange_Timer$precision_tag;
...
typedef TMilli /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$precision_tag;
typedef info_data_t /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t;
...
static void projectC$Pairing_Timer$fired(void );
#line 83
static void projectC$Info_Timer$fired(void );
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static void projectC$FakeSensor$readDone(error_t result, projectC$FakeSensor$val_t val);
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void projectC$OutOfRange_Timer$fired(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );
# 62 "/opt/tinyos-main-2.1.2/tos/interfaces/Init.nc"
...
uint8_t len);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void projectC$Pairing_Timer$startPeriodic(uint32_t dt);
#line 78
static void projectC$Pairing_Timer$stop(void );
#line 64
static void projectC$Info_Timer$startPeriodic(uint32_t dt);
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t projectC$FakeSensor$read(void );
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
...
message_t * msg);
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void projectC$OutOfRange_Timer$startOneShot(uint32_t dt);
# 31 "projectC.nc"
message_t projectC$packet[1000];
bool projectC$locked[1000];
bool projectC$paired[1000];
uint8_t projectC$paired_with[1000];
uint8_t projectC$received_from[1000];
char projectC$key[1000][21];
mote_type_t projectC$mote_type[1000];


info_data_t projectC$sensor_read[1000];


uint16_t projectC$pairing_Tms[1000];
uint16_t projectC$info_Tms[1000];
uint16_t projectC$outofrange_Tms[1000];

uint16_t projectC$last_x[1000];
uint16_t projectC$last_y[1000];
kinematic_status_t projectC$last_kinematic_status[1000];

char projectC$string1[1000][21];
char projectC$string2[1000][21];



static inline void projectC$set_mote_type(void );
static inline void projectC$set_default_string(void );
static inline void projectC$set_initial_parameters(void );

static inline my_msg_t *projectC$fill_pairing_msg(void );
static inline my_msg_t *projectC$fill_pairing_resp(void );
static inline my_msg_t *projectC$fill_info_msg(bool isResend);

static inline void projectC$send_broadcast_key(void );
static void projectC$send_pairing_resp(void );
static void projectC$send_info_message(bool isResend);

static inline const char *projectC$string_mote_type(mote_type_t mote_type);

static const char *projectC$string_ks(kinematic_status_t ks);
...
static inline void projectC$Pairing_Timer$fired(void );
#line 334
static inline void projectC$Info_Timer$fired(void );
#line 348
static inline void projectC$OutOfRange_Timer$fired(void );
...
#line 487
static inline void projectC$FakeSensor$readDone(error_t result, info_data_t data);
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt);
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static void /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void );
# 18 "FakeSensorP.nc"
static inline error_t /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );





static inline void /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void projectC$OutOfRange_Timer$startOneShot(uint32_t dt){
#line 73
...
inline static void projectC$Pairing_Timer$stop(void ){
#line 78
...
#line 421
{
  ...
  if (len != sizeof(my_msg_t )) {
      sim_log_error(187U, "message", "failed to read the content of the received message\n");
    }
  else 
    {
      ...
      sim_log_debug(188U, "message", "mote%hhu received from mote%hhu\n", TOS_NODE_ID, __nesc_ntoh_uint8(rec_msg->senderID.nxdata));
      if (__nesc_ntoh_uint8(rec_msg->msg_type.nxdata) == PAIRING) {

          if (strcmp(projectC$key[sim_node()], rec_msg->key) == 0) {
              projectC$received_from[sim_node()] = __nesc_ntoh_uint8(rec_msg->senderID.nxdata);
              sim_log_debug(189U, "message", "mote%hhu received PAIRING MESSAGE from mote%hhu with same key, sending PAIRING RESP\n", TOS_NODE_ID, projectC$received_from[sim_node()]);
              projectC$send_pairing_resp();
            }
        }
      ...
      if (__nesc_ntoh_uint8(rec_msg->msg_type.nxdata) == PAIRING_RESP) {

          projectC$paired_with[sim_node()] = __nesc_ntoh_uint8(rec_msg->senderID.nxdata);
          projectC$paired[sim_node()] = TRUE;

          sim_log_debug(190U, "message", "mote%hhu received PAIRING RESP from mote%hhu. Paired the two\n", TOS_NODE_ID, projectC$paired_with[sim_node()]);
          sim_log_debug(191U, "pairing_timer", "stopping PAIRING timer on mote%hhu\n", TOS_NODE_ID);
          projectC$Pairing_Timer$stop();
        }


      if (__nesc_ntoh_uint8(rec_msg->msg_type.nxdata) == INFO) {

          if (__nesc_ntoh_uint8(rec_msg->senderID.nxdata) == projectC$paired_with[sim_node()]) {

              sim_log_debug(192U, "info_message", "mote%hhu received INFO from PAIRED mote%hhu\n", TOS_NODE_ID, projectC$paired_with[sim_node()]);
              projectC$last_x[sim_node()] = __nesc_ntoh_uint16(rec_msg->x.nxdata);
              projectC$last_y[sim_node()] = __nesc_ntoh_uint16(rec_msg->y.nxdata);

              if (__nesc_ntoh_uint8(rec_msg->kinematic_status.nxdata) == FALLING) {
                  sim_log_debug(193U, "falling_alarm", " FALLING ALERT: Child has fallen, go pick him up at position (x:%hhu, y:%u)\n", TOS_NODE_ID, projectC$last_x[sim_node()], projectC$last_y[sim_node()]);
                }
              sim_log_debug(194U, "oor_timer", "mote%hhu started OutOfRange TIMER countdown\n", TOS_NODE_ID);
              projectC$OutOfRange_Timer$startOneShot(projectC$outofrange_Tms[sim_node()]);
            }
        }
    }
...
#line 127
{
  ...
  my_msg_t *msg = (my_msg_t *)projectC$Packet$getPayload(&projectC$packet[sim_node()], sizeof(my_msg_t ));

#line 131
  if (msg == (void *)0) {
      sim_log_error(152U, "pairing_resp_message", "failed to create the PAIRING RESPONSE message\n");
      return (void *)0;
    }


  __nesc_hton_uint8(msg->msg_type.nxdata, PAIRING_RESP);
  __nesc_hton_uint8(msg->senderID.nxdata, TOS_NODE_ID);
  strcpy(msg->key, "xxxxxxxxxxxxxxxxxxxx");
  __nesc_hton_uint16(msg->x.nxdata, 0);
  __nesc_hton_uint16(msg->y.nxdata, 0);
  __nesc_hton_uint8(msg->kinematic_status.nxdata, NONE);

  sim_log_debug(153U, "pairing_resp_message", "Mote%hhu set fields for the PAIRING RESPONSE message, senderID:%hhu, key:%s, x:%u, y:%u, kin_status:%s \n", TOS_NODE_ID, __nesc_ntoh_uint8(msg->senderID.nxdata), msg->key, __nesc_ntoh_uint16(msg->x.nxdata), __nesc_ntoh_uint16(msg->y.nxdata), projectC$string_ks(__nesc_ntoh_uint8(msg->kinematic_status.nxdata)));



  projectC$PacketAcknowledgements$requestAck(&projectC$packet[sim_node()]);
  sim_log_debug(154U, "pairing_resp_ack", "Mote%u Setting ack flag for the PAIRING RESPONSE message\n", TOS_NODE_ID);
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74e62b0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74e62b0, addr, msg, len);
#line 80
...
#line 85
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt){
#line 73
...
#line 18
{
  /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(10);
  return SUCCESS;
}

# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static error_t projectC$FakeSensor$read(void ){
#line 55
  unsigned char __nesc_result;
#line 55

#line 55
  __nesc_result = /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read();
#line 55
...
#line 158
  if (msg == (void *)0) {
      sim_log_error(155U, "info_message", "failed to create the INFO message\n");
      return (void *)0;
    }


  __nesc_hton_uint8(msg->msg_type.nxdata, INFO);
  __nesc_hton_uint8(msg->senderID.nxdata, TOS_NODE_ID);
  strcpy(msg->key, "xxxxxxxxxxxxxxxxxxxx");

  if (!isResend) {

      projectC$FakeSensor$read();

      __nesc_hton_uint16(msg->x.nxdata, projectC$sensor_read[sim_node()].x);
      projectC$last_x[sim_node()] = projectC$sensor_read[sim_node()].x;

      __nesc_hton_uint16(msg->y.nxdata, projectC$sensor_read[sim_node()].y);
      projectC$last_y[sim_node()] = projectC$sensor_read[sim_node()].y;


      if (projectC$sensor_read[sim_node()].kinematic_status >= (uint16_t )(65536 * 0.0) && projectC$sensor_read[sim_node()].kinematic_status < (uint16_t )(65536 * 0.3)) {
#line 179
          projectC$last_kinematic_status[sim_node()] = STANDING;
        }
#line 180
      if (projectC$sensor_read[sim_node()].kinematic_status >= (uint16_t )(65536 * 0.3) && projectC$sensor_read[sim_node()].kinematic_status < (uint16_t )(65536 * 0.6)) {
#line 180
          projectC$last_kinematic_status[sim_node()] = WALKING;
        }
#line 181
      if (projectC$sensor_read[sim_node()].kinematic_status >= (uint16_t )(65536 * 0.6) && projectC$sensor_read[sim_node()].kinematic_status < (uint16_t )(65536 * 0.9)) {
#line 181
          projectC$last_kinematic_status[sim_node()] = RUNNING;
        }
#line 182
      if (projectC$sensor_read[sim_node()].kinematic_status >= (uint16_t )(65536 * 0.9) && projectC$sensor_read[sim_node()].kinematic_status < (uint16_t )(65536 * 1.0)) {
#line 182
          projectC$last_kinematic_status[sim_node()] = FALLING;
        }
#line 183
      __nesc_hton_uint8(msg->kinematic_status.nxdata, projectC$last_kinematic_status[sim_node()]);
    }
  else 
    {
      __nesc_hton_uint16(msg->x.nxdata, projectC$last_x[sim_node()]);
      __nesc_hton_uint16(msg->y.nxdata, projectC$last_y[sim_node()]);
      __nesc_hton_uint8(msg->kinematic_status.nxdata, projectC$last_kinematic_status[sim_node()]);
    }

  sim_log_debug(156U, "info_message", "Mote%hhu set fields for the INFO message. senderID:%hhu, key:%s, x:%u, y:%u, kin_status:%s, isResend:%u \n", TOS_NODE_ID, __nesc_ntoh_uint8(msg->senderID.nxdata), msg->key, __nesc_ntoh_uint16(msg->x.nxdata), __nesc_ntoh_uint16(msg->y.nxdata), projectC$string_ks(__nesc_ntoh_uint8(msg->kinematic_status.nxdata)), isResend);



  projectC$PacketAcknowledgements$requestAck(&projectC$packet[sim_node()]);
  sim_log_debug(157U, "info_ack", "Mote%hhu Setting ack flag for the INFO message\n", TOS_NODE_ID);
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7696178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7696178, msg, payload, len);
#line 78
...
#line 104
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void projectC$Info_Timer$startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodic(1U, dt);
#line 64
}
#line 64
inline static void projectC$Pairing_Timer$startPeriodic(uint32_t dt){
#line 64
...
#line 285
{
  ...
  if (err == SUCCESS) {
      ...
      sim_log_debug(165U, "radio_status", "Radio ON on mote%hhu!\n", TOS_NODE_ID);
      if (!projectC$paired[sim_node()]) {
          sim_log_debug(166U, "pairing_timer", "Started PAIRING TIMER on mote%hhu (not already paired)\n", TOS_NODE_ID);
          projectC$Pairing_Timer$startPeriodic(projectC$pairing_Tms[sim_node()]);
        }
      else 
        {
          if (projectC$mote_type[sim_node()] == CHILD) {
              sim_log_debug(167U, "info_timer", "Started INFO TIMER on mote%hhu (already paired)\n", TOS_NODE_ID);
              projectC$Info_Timer$startPeriodic(projectC$info_Tms[sim_node()]);
            }
        }
    }
  else 
...

    {
      ...
      sim_log_error(168U, "radio_status", "Radio failed to start on node %hhu, retrying...\n", TOS_NODE_ID);
...
#line 313
{
  sim_log_debug(169U, "radio_status", "Radio on mote%hhu stopped!\n", TOS_NODE_ID);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74e78a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74e78a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74e78a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7855650){
#line 75
  switch (arg_0xb7855650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7855650);
#line 75
      break;
#line 75
    }
...
#line 104
  if (msg == (void *)0) {
      sim_log_error(150U, "pairing_message", "failed to create the PAIRING message\n");
      return (void *)0;
    }


  __nesc_hton_uint8(msg->msg_type.nxdata, PAIRING);
  __nesc_hton_uint8(msg->senderID.nxdata, TOS_NODE_ID);
  strcpy(msg->key, projectC$key[sim_node()]);
  __nesc_hton_uint16(msg->x.nxdata, 0);
  __nesc_hton_uint16(msg->y.nxdata, 0);
  __nesc_hton_uint8(msg->kinematic_status.nxdata, NONE);

  sim_log_debug(151U, "pairing_message", "Mote%hhu set fields for the PAIRING message. senderID:%hhu, key:%s, x:%u, y:%u, kin_status:%s \n", TOS_NODE_ID, __nesc_ntoh_uint8(msg->senderID.nxdata), msg->key, __nesc_ntoh_uint16(msg->x.nxdata), __nesc_ntoh_uint16(msg->y.nxdata), projectC$string_ks(__nesc_ntoh_uint8(msg->kinematic_status.nxdata)));
...
#line 202
{
  ...
  my_msg_t *msg = projectC$fill_pairing_msg();

  if (msg != (void *)0) {

      if (projectC$AMSend$send(AM_BROADCAST_ADDR, &projectC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {

          sim_log_debug(158U, "radio_send", "mote%hhu is broadcasting the PAIRINIG message at time %s\n", TOS_NODE_ID, sim_time_string());
          sim_log_debug(159U, "radio_status", "radio on mote%hhu has been locked\n", TOS_NODE_ID);
          projectC$locked[sim_node()] = TRUE;
        }
    }
}
...
#line 320
{
  ...
  sim_log_debug(170U, "pairing_timer", "pairing Timer on mote%hhu fired\n", TOS_NODE_ID);

  if (projectC$locked[sim_node()]) {
      sim_log_debug(171U, "radio_send", "Radio on mote%hhu was locked when timer fired, do nothing\n", TOS_NODE_ID);
    }
  else {
      sim_log_debug(172U, "radio_send", "Radio on mote%hhu not locked, sending the PAIRING message\n", TOS_NODE_ID);
      projectC$send_broadcast_key();
    }
}
...
#line 334
{
  ...
  sim_log_debug(173U, "info_timer", "info Timer on mote%hhu fired\n", TOS_NODE_ID);

  if (projectC$locked[sim_node()]) {
      sim_log_debug(174U, "radio_send", "Radio on mote%hhu was locked when timer fired, do nothing\n", TOS_NODE_ID);
    }
  else {
      sim_log_debug(175U, "radio_send", "Radio on mote%hhu not locked, sending the INFO message\n", TOS_NODE_ID);
      projectC$send_info_message(FALSE);
    }
}
...
#line 348
{
  ...
  sim_log_debug(176U, "oor_timer", "out_of_range Timer on mote%hhu fired\n", TOS_NODE_ID);

  sim_log_debug(177U, "missing_alarm", " MISSING ALERT: Mote%hhu has not received messages from child for more than 60s. Last known position was (x:%u, y:%u)\n", TOS_NODE_ID, projectC$last_x[sim_node()], projectC$last_y[sim_node()]);
}
...
#line 487
{
  ...
  projectC$sensor_read[sim_node()] = data;
}

# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static void /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val){
#line 63
  projectC$FakeSensor$readDone(result, val);
#line 63
}
#line 63
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 27
  data.x = /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16();
  data.y = /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16();
  data.kinematic_status = /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16();
  /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(SUCCESS, data);
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73673a8){
#line 83
  switch (arg_0xb73673a8) {
#line 83
    case 0U:
#line 83
      projectC$Pairing_Timer$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      projectC$Info_Timer$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      projectC$OutOfRange_Timer$fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      /*projectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73673a8);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(226U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(225U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(222U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(223U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(215U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(205U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 225
  sim_log_debug(212U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(217U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 84
{
  ...
  if ((uint8_t )(TOS_NODE_ID / 2) == 0) {
#line 86
      strcpy(projectC$key[sim_node()], projectC$string1[sim_node()]);
    }
#line 87
  if ((uint8_t )(TOS_NODE_ID / 2) == 1) {
#line 87
      strcpy(projectC$key[sim_node()], projectC$string2[sim_node()]);
    }
  sim_log_debug(149U, "setting", "Mote%hhu set key to %s\n", TOS_NODE_ID, projectC$key[sim_node()]);
}
...
#line 74
{
  ...
  if (TOS_NODE_ID % 2 == 0) {
      projectC$mote_type[sim_node()] = PARENT;
    }
  else 
#line 78
    {
      projectC$mote_type[sim_node()] = CHILD;
    }
  sim_log_debug(148U, "setting", "Mote%hhu set to type %s\n", TOS_NODE_ID, projectC$string_mote_type(projectC$mote_type[sim_node()]));
}
...
#line 92
{
  ...
  projectC$locked[sim_node()] = FALSE;
  projectC$paired[sim_node()] = FALSE;
  projectC$set_mote_type();
  projectC$set_default_string();
}
...
#line 276
{
  ...
  sim_log_debug(164U, "boot", "Application booted on node %hhu.\n", TOS_NODE_ID);
  projectC$set_initial_parameters();
  projectC$SplitControl$start();
}
...
#line 218
{
  ...
  my_msg_t *msg = projectC$fill_pairing_resp();

  if (msg != (void *)0) {

      if (projectC$AMSend$send(projectC$received_from[sim_node()], &projectC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {

          sim_log_debug(160U, "radio_send", "mote%hhu sending unicast reply to the PAIRINIG message to mote%hhu at time %s \n", TOS_NODE_ID, projectC$received_from[sim_node()], sim_time_string());
          sim_log_debug(161U, "radio_status", "radio on mote%hhu has been locked\n", TOS_NODE_ID);
          projectC$locked[sim_node()] = TRUE;
        }
    }
}
...
#line 359
{
  ...
  if (err != SUCCESS) {
      sim_log_error(178U, "radio_send", "Packet sending from mote%hhu failed to be sent\n", TOS_NODE_ID);
      return;
    }
  else {
      sim_log_debug(179U, "radio_send", "Packet sending from mote%hhu sent correctly\n", TOS_NODE_ID);

      sim_log_debug(180U, "radio_status", "radio on mote%hhu has been unlocked\n", TOS_NODE_ID);
      projectC$locked[sim_node()] = FALSE;
...

      {
        ...
        my_msg_t *msg = (my_msg_t *)projectC$Packet$getPayload(buf, sizeof(my_msg_t ));

#line 380
        if (msg == (void *)0) {
            sim_log_error(181U, "message", "failed to parse the sent message in sendDone\n");
            return;
          }


        if (!projectC$PacketAcknowledgements$wasAcked(buf)) {

            if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == PAIRING_RESP) {
                sim_log_debug(182U, "pairing_resp_ack", "PAIRING RESP ACK not received by mote%hhu, resending...\n", TOS_NODE_ID);
                projectC$send_pairing_resp();
              }

            if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == INFO) {
                sim_log_debug(183U, "info_ack", "INFO ACK not received by mote%hhu, resending...\n", TOS_NODE_ID);
                projectC$send_info_message(TRUE);
              }
          }
        else 
          {
            ...
            if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == PAIRING_RESP) {
                sim_log_debug(184U, "pairing_resp_ack", "PAIRING RESP ACK received by mote%hhu\n", TOS_NODE_ID);
                if (projectC$mote_type[sim_node()] == CHILD) {
                    sim_log_debug(185U, "info_timer", "starting INFO timer on mote%hhu\n", TOS_NODE_ID);
                    projectC$Info_Timer$startPeriodic(projectC$info_Tms[sim_node()]);
                  }
              }

            if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == INFO) {
                sim_log_debug(186U, "info_ack", "INFO ACK received by mote%u\n", TOS_NODE_ID);
              }
          }
      }
    }
...
#line 236
{
  ...
  my_msg_t *msg = projectC$fill_info_msg(isResend);

  if (msg != (void *)0) {

      if (projectC$AMSend$send(projectC$paired_with[sim_node()], &projectC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {

          sim_log_debug(162U, "radio_send", "mote%hhu is sending the INFO message at time %s\n", TOS_NODE_ID, sim_time_string());
          sim_log_debug(163U, "radio_status", "radio on mote%hhu has been locked\n", TOS_NODE_ID);
          projectC$locked[sim_node()] = TRUE;
        }
    }
}
...
#line 285
  ...
  sim_log_debug(214U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(220U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 101
      sim_log_debug(200U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(201U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(202U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(203U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(221U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(224U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(213U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "projectC$paired"))
  {
    *addr = (uintptr_t)&projectC$paired[__nesc_mote];
    *size = sizeof(projectC$paired[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$paired_with"))
  {
    *addr = (uintptr_t)&projectC$paired_with[__nesc_mote];
    *size = sizeof(projectC$paired_with[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$received_from"))
  {
    *addr = (uintptr_t)&projectC$received_from[__nesc_mote];
    *size = sizeof(projectC$received_from[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "projectC$mote_type"))
  {
    *addr = (uintptr_t)&projectC$mote_type[__nesc_mote];
    *size = sizeof(projectC$mote_type[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$sensor_read"))
  {
    *addr = (uintptr_t)&projectC$sensor_read[__nesc_mote];
    *size = sizeof(projectC$sensor_read[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$pairing_Tms"))
  {
    *addr = (uintptr_t)&projectC$pairing_Tms[__nesc_mote];
    *size = sizeof(projectC$pairing_Tms[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$info_Tms"))
  {
    *addr = (uintptr_t)&projectC$info_Tms[__nesc_mote];
    *size = sizeof(projectC$info_Tms[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$outofrange_Tms"))
  {
    *addr = (uintptr_t)&projectC$outofrange_Tms[__nesc_mote];
    *size = sizeof(projectC$outofrange_Tms[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$last_x"))
  {
    *addr = (uintptr_t)&projectC$last_x[__nesc_mote];
    *size = sizeof(projectC$last_x[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$last_y"))
  {
    *addr = (uintptr_t)&projectC$last_y[__nesc_mote];
    *size = sizeof(projectC$last_y[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$last_kinematic_status"))
  {
    *addr = (uintptr_t)&projectC$last_kinematic_status[__nesc_mote];
    *size = sizeof(projectC$last_kinematic_status[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$string1"))
  {
    *addr = (uintptr_t)&projectC$string1[__nesc_mote];
    *size = sizeof(projectC$string1[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$string2"))
  {
    *addr = (uintptr_t)&projectC$string2[__nesc_mote];
    *size = sizeof(projectC$string2[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&projectC$locked[__nesc_mote], 0, sizeof projectC$locked[__nesc_mote]);
  memset((void *)&projectC$paired[__nesc_mote], 0, sizeof projectC$paired[__nesc_mote]);
  memset((void *)&projectC$paired_with[__nesc_mote], 0, sizeof projectC$paired_with[__nesc_mote]);
  memset((void *)&projectC$received_from[__nesc_mote], 0, sizeof projectC$received_from[__nesc_mote]);
  memset((void *)&projectC$key[__nesc_mote], 0, sizeof projectC$key[__nesc_mote]);
  memset((void *)&projectC$mote_type[__nesc_mote], 0, sizeof projectC$mote_type[__nesc_mote]);
  memset((void *)&projectC$sensor_read[__nesc_mote], 0, sizeof projectC$sensor_read[__nesc_mote]);
  projectC$pairing_Tms[__nesc_mote] = 5000;
  projectC$info_Tms[__nesc_mote] = 10000;
  projectC$outofrange_Tms[__nesc_mote] = 60000;
  memset((void *)&projectC$last_x[__nesc_mote], 0, sizeof projectC$last_x[__nesc_mote]);
  memset((void *)&projectC$last_y[__nesc_mote], 0, sizeof projectC$last_y[__nesc_mote]);
  memset((void *)&projectC$last_kinematic_status[__nesc_mote], 0, sizeof projectC$last_kinematic_status[__nesc_mote]);
  memcpy((void *)&projectC$string1[__nesc_mote], (void *)&(char [21]){ "qwertyuiopasdfghjklz" }, sizeof projectC$string1[__nesc_mote]);
  memcpy((void *)&projectC$string2[__nesc_mote], (void *)&(char [21]){ "zlkjhgfdsapoiuytrewq" }, sizeof projectC$string2[__nesc_mote]);
