...
#line 428
{
  ...
  if (len != sizeof(my_msg_t )) {
      sim_log_error(188U, "message", "failed to read the content of the received message\n");
    }
  else 
    {
      ...
      if (__nesc_ntoh_uint8(rec_msg->msg_type.nxdata) == PAIRING_RESP) {
          ...
          sim_log_debug(190U, "message", "mote%hhu received PAIRING RESP from mote%hhu. Pairing with it\n", TOS_NODE_ID, projectC$paired_with[sim_node()]);
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76b7ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76b7ac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76b7ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76b7108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76b7108, msg, error);
#line 110
}
#line 110
...
#line 380
        ...
        if (!projectC$PacketAcknowledgements$wasAcked(buf)) {
            ...
            if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == PAIRING) {
                sim_log_error(182U, "message", "mote%hhu FAILED TO RECEIVE A PARINING ACK\n");
              }

            if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == PAIRING_RESP) {
                sim_log_debug(183U, "pairing_resp_ack", "PAIRING RESP ACK not received by mote%hhu, resending...\n", TOS_NODE_ID);
                projectC$send_pairing_resp();
              }

            if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == INFO) {
                sim_log_debug(184U, "info_ack", "INFO ACK not received by mote%hhu, resending...\n", TOS_NODE_ID);
...

          {
            ...
            if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == PAIRING_RESP && projectC$paired[sim_node()]) {
                sim_log_debug(185U, "pairing_resp_ack", "PAIRING RESP ACK received by mote%hhu\n", TOS_NODE_ID);
                if (projectC$mote_type[sim_node()] == CHILD) {
                    sim_log_debug(186U, "info_timer", "starting INFO timer on mote%hhu\n", TOS_NODE_ID);
                    projectC$Info_Timer$startPeriodic(projectC$info_Tms[sim_node()]);
                  }
              }

            if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == INFO) {
                sim_log_debug(187U, "info_ack", "INFO ACK received by mote%u\n", TOS_NODE_ID);
              }
          }
      }
    }
