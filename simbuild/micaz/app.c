...
#line 260
extern double erfc(double arg_0xb7b538c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79fd840), 
int (*key_eq_fn)(void *arg_0xb79fdc88, void *arg_0xb79fde00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78cc9b8, int arg_0xb78ccb10);
static double RandomUniform(void );
...
static const char *projectC$string_msg_type(msg_type_t msg_type);
...
#line 430
{
  ...
  if (len != sizeof(my_msg_t )) {
      sim_log_error(191U, "message", "failed to read the content of the received message\n");
    }
  else 
    {
      ...
      if (__nesc_ntoh_uint8(rec_msg->msg_type.nxdata) == PAIRING) {
          if (strcmp(projectC$key[sim_node()], rec_msg->key) == 0) {
              ...
              sim_log_debug(192U, "message", "mote%hhu received PAIRING MESSAGE from mote%hhu with same key, sending PAIRING RESP\n", TOS_NODE_ID, projectC$received_from[sim_node()]);
      ...
      if (__nesc_ntoh_uint8(rec_msg->msg_type.nxdata) == PAIRING_RESP) {
          ...
          sim_log_debug(193U, "message", "mote%hhu received PAIRING RESP from mote%hhu. Pairing with it\n", TOS_NODE_ID, projectC$paired_with[sim_node()]);
          sim_log_debug(194U, "pairing_timer", "stopping PAIRING timer on mote%hhu\n", TOS_NODE_ID);
      ...
      if (__nesc_ntoh_uint8(rec_msg->msg_type.nxdata) == INFO) {
          ...
          if (__nesc_ntoh_uint8(rec_msg->senderID.nxdata) == projectC$paired_with[sim_node()]) {
              ...
              sim_log_debug(195U, "info_message", "mote%hhu received INFO from paired mote%hhu\n", TOS_NODE_ID, projectC$paired_with[sim_node()]);
              ...
              if (__nesc_ntoh_uint8(rec_msg->kinematic_status.nxdata) == FALLING) {
                  sim_log_debug(196U, "falling_alarm", " FALLING ALERT: Child has fallen, go pick him up at position (x:%hhu, y:%u)\n", TOS_NODE_ID, projectC$last_x[sim_node()], projectC$last_y[sim_node()]);
                }
              sim_log_debug(197U, "oor_timer", "mote%hhu started OutOfRange TIMER countdown\n", TOS_NODE_ID);
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb766cac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb766cac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb766cac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 131
  ...
  sim_log_debug(153U, "pairing_resp_message", "Mote%hhu set fields for the PAIRING RESPONSE message, senderID:%hhu, key:%s, x:%u, y:%u, kin_status:%s, type:%s \n", TOS_NODE_ID, __nesc_ntoh_uint8(msg->senderID.nxdata), msg->key, __nesc_ntoh_uint16(msg->x.nxdata), __nesc_ntoh_uint16(msg->y.nxdata), projectC$string_ks(__nesc_ntoh_uint8(msg->kinematic_status.nxdata)), projectC$string_msg_type(__nesc_ntoh_uint8(msg->msg_type.nxdata)));
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb766c108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb766c108, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7669178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7669178, msg, payload, len);
#line 78
...
#line 285
{
  ...
  if (err == SUCCESS) {
      ...
      sim_log_debug(166U, "radio_status", "Radio ON on mote%hhu!\n", TOS_NODE_ID);
      if (!projectC$paired[sim_node()]) {
          sim_log_debug(167U, "pairing_timer", "Started PAIRING TIMER on mote%hhu (not already paired)\n", TOS_NODE_ID);
          projectC$Pairing_Timer$startPeriodic(projectC$pairing_Tms[sim_node()]);
        }
      else 
        {
          if (projectC$mote_type[sim_node()] == CHILD) {
              sim_log_debug(168U, "info_timer", "Started INFO TIMER on mote%hhu (already paired)\n", TOS_NODE_ID);
...

    {
      ...
      sim_log_error(169U, "radio_status", "Radio failed to start on node %hhu, retrying...\n", TOS_NODE_ID);
...
#line 313
{
  sim_log_debug(170U, "radio_status", "Radio on mote%hhu stopped!\n", TOS_NODE_ID);
}
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7828650){
#line 75
  switch (arg_0xb7828650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7828650);
#line 75
      break;
#line 75
    }
...
#line 320
{
  ...
  sim_log_debug(171U, "pairing_timer", "pairing Timer on mote%hhu fired\n", TOS_NODE_ID);

  if (projectC$locked[sim_node()]) {
      sim_log_debug(172U, "radio_send", "Radio on mote%hhu was locked when timer fired, do nothing\n", TOS_NODE_ID);
    }
  else {
      sim_log_debug(173U, "radio_send", "Radio on mote%hhu not locked, sending the PAIRING message\n", TOS_NODE_ID);
...
#line 334
{
  ...
  sim_log_debug(174U, "info_timer", "info Timer on mote%hhu fired\n", TOS_NODE_ID);

  if (projectC$locked[sim_node()]) {
      sim_log_debug(175U, "radio_send", "Radio on mote%hhu was locked when timer fired, do nothing\n", TOS_NODE_ID);
    }
  else {
      sim_log_debug(176U, "radio_send", "Radio on mote%hhu not locked, sending the INFO message\n", TOS_NODE_ID);
...
#line 348
{
  ...
  sim_log_debug(177U, "oor_timer", "out_of_range Timer on mote%hhu fired\n", TOS_NODE_ID);

  sim_log_debug(178U, "missing_alarm", " MISSING ALERT: Mote%hhu has not received messages from child for more than 60s. Last known position was (x:%u, y:%u)\n", TOS_NODE_ID, projectC$last_x[sim_node()], projectC$last_y[sim_node()]);
}
...
#line 276
{
  ...
  sim_log_debug(165U, "boot", "Application booted on node %hhu.\n", TOS_NODE_ID);
...
#line 218
{
  ...
  if (msg != (void *)0) {
      ...
      if (projectC$AMSend$send(projectC$received_from[sim_node()], &projectC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(160U, "message", "send_pairing_resp() type:%s", projectC$string_msg_type(__nesc_ntoh_uint8(msg->msg_type.nxdata)));
          sim_log_debug(161U, "radio_send", "mote%hhu sending unicast reply to the PAIRINIG message to mote%hhu at time %s \n", TOS_NODE_ID, projectC$received_from[sim_node()], sim_time_string());
          sim_log_debug(162U, "radio_status", "radio on mote%hhu has been locked\n", TOS_NODE_ID);
          projectC$locked[sim_node()] = TRUE;
        }
    }
}
...
#line 359
{
  ...
  if (err != SUCCESS) {
      sim_log_error(179U, "radio_send", "Packet sending from mote%hhu failed to be sent\n", TOS_NODE_ID);
      return;
    }
  else {
      sim_log_debug(180U, "radio_send", "Packet sending from mote%hhu sent correctly\n", TOS_NODE_ID);

      sim_log_debug(181U, "radio_status", "radio on mote%hhu has been unlocked\n", TOS_NODE_ID);
      projectC$locked[sim_node()] = FALSE;
...
#line 380
        if (msg == (void *)0) {
            sim_log_error(182U, "message", "failed to parse the sent message in sendDone\n");
            return;
          }


        sim_log_error(183U, "message", "mote%hhu WAS ACKED: %u, type:%s\n", TOS_NODE_ID, projectC$PacketAcknowledgements$wasAcked(buf), projectC$string_msg_type(__nesc_ntoh_uint8(msg->msg_type.nxdata)));
        if (!projectC$PacketAcknowledgements$wasAcked(buf)) {

            if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == PAIRING) {
                sim_log_error(184U, "message", "senderID:%hhu,key:%s,type:%s,x:%u", __nesc_ntoh_uint8(msg->senderID.nxdata), msg->key, projectC$string_msg_type(__nesc_ntoh_uint8(msg->msg_type.nxdata)), __nesc_ntoh_uint16(msg->x.nxdata));
              }

            if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == PAIRING_RESP) {
                sim_log_error(185U, "message", "mote%hhu WAS NOT ACKED in PAIRING RESPONSE: %u\n", TOS_NODE_ID);
                sim_log_debug(186U, "pairing_resp_ack", "PAIRING RESP ACK not received by mote%hhu, resending...\n", TOS_NODE_ID);
                projectC$send_pairing_resp();
              }

            if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == INFO && projectC$retransmittion_counter[sim_node()] < 2) {
                sim_log_debug(187U, "info_ack", "INFO ACK not received by mote%hhu, resending...\n", TOS_NODE_ID);
        ...
        else 
          {
            ...
            if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == PAIRING_RESP && projectC$paired[sim_node()]) {
                sim_log_debug(188U, "pairing_resp_ack", "PAIRING RESP ACK received by mote%hhu\n", TOS_NODE_ID);
                if (projectC$mote_type[sim_node()] == CHILD) {
                    sim_log_debug(189U, "info_timer", "starting INFO timer on mote%hhu\n", TOS_NODE_ID);
                    projectC$Info_Timer$startPeriodic(projectC$info_Tms[sim_node()]);
                  }
              }

            if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == INFO) {
                sim_log_debug(190U, "info_ack", "INFO ACK received by mote%u\n", TOS_NODE_ID);
...
#line 236
{
  ...
  if (msg != (void *)0) {
      ...
      if (projectC$AMSend$send(projectC$paired_with[sim_node()], &projectC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          ...
          sim_log_debug(163U, "radio_send", "mote%hhu is sending the INFO message at time %s\n", TOS_NODE_ID, sim_time_string());
          sim_log_debug(164U, "radio_status", "radio on mote%hhu has been locked\n", TOS_NODE_ID);
          projectC$locked[sim_node()] = TRUE;
        }
    }
}
